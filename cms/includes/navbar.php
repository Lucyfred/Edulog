...
if(check_avatar($_SESSION["user_id"]) == true){
    echo '<img src="' . $url_site . '/cms/assets/img/avatar/' . user_info($_SESSION["user_id"])["avatar"] . '" class="rounded-circle shadow avatar-sm" id="avatar-sm" alt="avatar" onerror="this.style.display=\'none\'; this.nextElementSibling.style.display=\'inline-block\';">';
} else{
    echo '<img src="' . $url_site . '/cms/assets/img/avatar/avatar-settings.png" class="rounded-circle shadow avatar-sm" id="avatar-sm"></img>';
}
