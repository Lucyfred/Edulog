...
// Obtenemos los usuarios que aún no rellenaron el formulario de bienvenida
$usuarios = get_all_users_nr();

// Web con una tabla donde se mostrarán a los usuarios que todavía no han rellenado el formulario
// Esta web solo estará disponible para el administrador, podrá actualizar datos o eliminar al usuario
?>
...
<body>
    ...
    <script>
        $(document).ready(function() {
            /**
             * Oculta el loader y muestra la web
             */
            $("#div-loader").addClass("d-none");
            $("#div-content").removeClass("d-none");

            /**
             * Evento de cambio, el select, al cambiar, revisa los valores y manda un ajax
             */
            $(".id_rol").on("change", function() {
                ...
                $.ajax({
                    url: "/cms/includes/ajax/edit_rol_admin.php",
                    method: "POST",
                    data: {
                        idUser: $idUser,
                        idRol: $idRol
            ...
            /**
             * Al mostrar el modal, hace focus en el campo pass
             */
            ...
            /**
             * Evento de escucha, al dar click añade un input oculto con datos
             */
            ...
            $(".btn-success-pass").on("click", function() {
                ...
                $.ajax({
                    url: "/cms/includes/ajax/edit_pass_admin.php",
                    method: "POST",
                    data: {
                        idUser: $idUser,
                        pass: $pass
            ...
            $(".btn-remove-user").on("click", function() {
                ...
                if (confirmacion) {
                    $.ajax({
                        url: "/cms/includes/ajax/borrar_usuario_admin.php",
                        method: "POST",
                        data: {
                            idUser: $idUser
                        },
            ...
            $("#btn-save-usuario").on("click", function() {
                ...
                $.ajax({
                    url: "/cms/includes/ajax/crear_usuario_admin.php",
                    method: "POST",
