...
// Obtenemos los usuarios que si rellenaron el formulario de bienvenida
$usuarios = get_all_users();

// Web con una tabla donde se mostrarán a los usuarios que si han rellenado el formulario
                        ...
                        <tbody id="table-body">
                            <?php if (!empty($usuarios)) { ?>
                                <?php foreach ($usuarios as $usuario): ?>
                                    <tr>
                                        <td class="col"><?= $usuario["nombre"] ?></td>
                                        <td class="col"><?= $usuario["email"] ?></td>
                                        <td class="col"><?= $usuario["nombre_centro"] ?></td>
                                        <td class="col"><?= $usuario["nombre_empresa"] ?></td>
